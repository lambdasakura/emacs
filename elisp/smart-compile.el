...
(defcustom smart-compile-alist '(
  ...
  ("\\.c\\'"          . "gcc -g -O2 %f -W -Wall -Wextra -Wformat=2 -Wstrict-aliasing=2 -Wcast-qual -Wcast-align \
 -Wwrite-strings -Wconversion -Wfloat-equal -Wpointer-arith -Wswitch-enum \
-lm -o %n")
  ;;  ("\\.c\\'"          . "gcc -O2 %f -lm -o %n && ./%n")
  ("\\.[Cc]+[Pp]*\\'" . "g++ -g -O2 %f -lm -W -Wall -Wextra -Wformat=2 -Wstrict-aliasing=2 -Wcast-qual -Wcast-align \
 -Wwrite-strings -Wconversion -Wfloat-equal -Wpointer-arith -Wswitch-enum \
-o %n")
